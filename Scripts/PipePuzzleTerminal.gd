...
@export_enum("Default 3x3", "3x3", "4x4", "5x5", "6x6", "7x7", "9x8", "9x9", "Wire Tree 9x8", "Wire Full 6x6", "2x2") var puzzle_layout: int = 0
...
func _ready() -> void:
	...
	if puzzle_definition.is_empty():
		match puzzle_layout:
			...
			10:
				_puzzle = PipePuzzleDefinition.create_puzzle_2x2()
			_:
